...
- [docs/en/cli-guide.md](./docs/en/cli-guide.md) — Full CLI reference
- [docs/en/getting-started.md](./docs/en/getting-started.md) — First-run workflow and quick reference
